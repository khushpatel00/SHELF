...
import { getAllBooks } from "../Actions/libActions";
        ...
        <>
            <div className='flex flex-row flex-wrap justify-center'>
                {books.map(((book, i) => {
                    return (
                        <div
                            key={i} onClick={() => singleBookPage(i)} className='basis-1/8 xl:basis-1/4 cursor-pointer bg-amber-100 hover:scale-105 m-3 my-6 lg:min-w-[20vw] xl:min-w-[15vw] md:min-w-[25vw] duration-200 *:duration-150 min-w-[50vw] max-w-fit w-auto aspect-2/3 relative border-s-8 border-amber-200'>
