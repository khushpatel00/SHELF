    ...
    return (
        <>
            <div className='flex flex-row flex-wrap '>
                {books.map(((book, i) => {
                    return <div
                        key={i} onClick={() => singleBookPage(i)} className='basis-1/8 cursor-pointer bg-amber-100 hover:scale-105 mx-auto lg:ms-auto lg:min-w-[20vw] xl:min-w-[15vw] md:min-w-[25vw] duration-200 *:duration-150 min-w-[50vw] max-w-fit w-auto aspect-2/3 relative border-s-8 border-amber-200'>
